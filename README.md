...
# Часть 1. Напишите простую игру «Угадай число». Пользователь вводит некоторое число от 0 до 9. Компьютер также генерирует случайное число от 0 до 9. Если значения равны, пользователь получит сообщение «Вы выиграли». В другом случае - «Вы проиграли». - Создать запрос на получение.
